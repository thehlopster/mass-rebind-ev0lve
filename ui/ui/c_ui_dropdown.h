...
#ifndef GIDEONPROJECT_MENU_C_UI_DROPDOWN_H
#define GIDEONPROJECT_MENU_C_UI_DROPDOWN_H

#include "c_ui_element.h"

class c_ui_dropdown : public c_ui_element {
public:
    ...
    e_control_type get_control_type() override { return CONTROL_DROPDOWN; }
...
#endif //GIDEONPROJECT_MENU_C_UI_DROPDOWN_H
